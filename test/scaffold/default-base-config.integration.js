...
describe('#defaultBaseConfig', function() {
  it('will return expected configuration', function() {
    ...
    butd.spawn.datadir.should.equal(home + '/.dash');
    butd.spawn.exec.should.equal(path.resolve(__dirname, process.env.HOME, './.dash/butd'));
  });
  ...
  it('be able to specify a datadir', function() {
    ...
    info.config.servicesConfig.butd.spawn.datadir.should.equal('./data2');
  });
});
