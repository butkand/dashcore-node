...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for butd is necessary for this upgrade with the "reindex=1" dash.conf option. \n' +
                 ...
                 'https://github.com/dashevo/dashcore-node/blob/butd/docs/upgrade.md \n');
        ...
        servicesConfig: {
          butd: {
            spawn: {
              ...
              exec: path.resolve(__dirname, '../../bin/butd')
            }
          }
        }
      };
